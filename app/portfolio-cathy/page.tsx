...
export default function PortfolioCathy() {
  ...
  const availablePools = [
    { id: 'eurc-g', name: 'EURC-G M', fullName: 'EURC-Gold Monthly', minAmount: 0, duration: 31, apr: 5.000, network: 'ERC20', image: '🥇' },
    { id: 'eurc-s', name: 'EURC-S M', fullName: 'EURC-Silver Monthly', minAmount: 0, duration: 31, apr: 2.000, network: 'ERC20', image: '🥈' },
    { id: 'eurc-b', name: 'EURC-B M', fullName: 'EURC-Bronze Monthly', minAmount: 0, duration: 31, apr: 1.000, network: 'ERC20', image: '🥉' }
  ];

  // Calcul des rendements
  const calculateReturns = (amount: number, apr: number, days: number = 31) => {
  ...
  // Position active (simulée) - utilise les valeurs calculées dynamiquement
  const myStaking = mounted ? {
    pool: 'EURC-B M',
    fullName: 'EURC-Bronze Monthly',
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-white">Cathy Miquel</h1>
              <span className="text-purple-300">Portfolio Staking</span>
            </div>
            ...
            <div className="flex flex-col justify-end">
              {calculatedReturns && (
                <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                  ...
                  <div className="text-white text-lg font-bold">{calculatedReturns.totalReturn} EURC</div>
                  <div className="text-green-300 text-xs">Quotidien: {calculatedReturns.dailyReturn} EURC</div>
                </div>
              )}
            </div>
          </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-purple-500/10">
                      ...
                      <td className="py-4">
                        <div className="text-green-400 font-medium">{myStaking.totalProfit} EURC</div>
                      </td>
                      <td className="py-4">
                        <div className="text-green-400 font-medium">{myStaking.yesterdayProfit} EURC</div>
                      </td>
                      <td className="py-4">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-purple-500/20">
                      ...
                      <th className="text-left py-3 text-sm font-medium text-purple-200">Durée</th>
                      <th className="text-left py-3 text-sm font-medium text-purple-200">Taux d&rsquo;Intérêt</th>
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-purple-500/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-white text-xl font-bold">{myStaking.amountStaked.toLocaleString()} EURC</div>
              </div>
              <TrendingUp className="h-8 w-8 text-purple-400" />
            </div>
          </div>
          <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-green-500/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-green-400 text-xl font-bold">{myStaking.totalProfit} EURC</div>
              </div>
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-blue-500/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-blue-400 text-xl font-bold">{myStaking.yesterdayProfit} EURC</div>
              </div>
