...
export default function PortfolioFrancois() {
  ...
  // Fonction de formatage cohérente pour éviter les erreurs d'hydratation
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-purple-500/10">
                      ...
                      <td className="py-4">
                        <div className="text-white font-medium">{formatNumber(myStaking.amountStaked)}</div>
                  ...
                  <tbody>
                    {availablePools.map((pool) => (
                      <tr key={pool.id} className="border-b border-purple-500/10 hover:bg-purple-500/5 transition-colors">
                        ...
                        <td className="py-4">
                          <div className="text-white font-medium">{formatNumber(pool.minAmount)}</div>
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-purple-500/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-white text-xl font-bold">{formatNumber(myStaking.amountStaked)} EUR</div>
              </div>
              <TrendingUp className="h-8 w-8 text-purple-400" />
            </div>
          </div>
